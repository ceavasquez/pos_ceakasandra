...
if (isset($_POST['btn_login'])) {
  ...
  $select = $pdo->prepare("select * from tbl_users where useremail='$useremail' OR username='$useremail' AND password='$password'");
  $select->execute();

  $row = $select->fetch(PDO::FETCH_ASSOC);
  
  print_r($row);
  if (is_array($row) && ($row['useremail'] == $useremail || $row['username'] == $useremail) && $row['password'] == $password) {
  ...
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
         <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" class="h1 main-title"><b>POS_</b>SEYA</a> 
